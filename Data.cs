...
{
    /// <summary>
    /// получить все данные для этого образца.
    /// все возможные типы пола
    /// уровень, на котором основаны стены
    /// </summary>
    public class Data
   {
      ...
      private Document m_document;
        ...
        /// <summary>
        /// Тип этажа, который будет использоваться новым этажом вместо типа по умолчанию.
        /// </summary>
        public FloorType FloorType
      {
        ...
        /// <summary>
        /// Уровень, на котором будет располагаться пол.
        /// </summary>
        public Level Level
      {
         get
        ...
        /// <summary>
        /// Массив плоских линий и дуг, представляющих горизонтальный профиль пола.
        /// </summary>
        public CurveArray Profile
      {
        ...
        /// <summary>
        /// Если установлено, указывает, что пол является структурным по своей природе.
        /// </summary>
        ...
        public double MaxLength
      {
        ...
        /// <summary>
        /// Список всех типов этажей, имена которых могут использоваться этажом.
        /// </summary>
        public List<string> FloorTypesName
      {
        ...
        /// <summary>
        /// Получить все данные, необходимые для создания пола.
        /// </summary>
        ...
        public void ObtainData(ExternalCommandData commandData)
      {
        ...
        /// <summary>
        /// Установите тип этажа, который будет генерироваться по его имени.
        /// </summary>
        ...
        public void ChooseFloorType(string typeName)
      {
        ...
        /// <summary>
        /// Получите все типы, доступные для пола.
        /// </summary>
        /// <param name="elements">все элементы в документе.</param>
        private void ObtainFloorTypes(FilteredElementIterator elements)
      {
        ...
        /// <summary>
        /// Получите уровень стены
        /// </summary>
        /// <param name="walls">выбор стен, образующих замкнутый контур </param>
        private void ObtainLevel(ElementSet walls)
      {
        ...
        /// <summary>
        /// Получить профиль для создания пола.
        /// </summary>
        /// <param name="walls">выбор стен, образующих замкнутый контур</param>
        private void ObtainProfile(ElementSet walls)
      {
        ...
        /// <summary>
        /// Создайть 2D-данные для панели предварительного просмотра (preview)..
        /// </summary>
        private void Generate2D()
      {
        ...
        /// <summary>
        /// Оценитm, что текущая точка — left_bottom или right_up.
        /// </summary>
        ...
        static private void FindMinMax(Autodesk.Revit.DB.XYZ point, ref double xMin, ref double xMax, ref double yMin, ref double yMax)
      {
        ...
        /// <summary>
        /// Фильтровать элементы без стен.
        /// </summary>
        /// <param name="miscellanea">Выбранные в данный момент элементы в Autodesk Revit</param>
        /// <returns></returns>
        ...
        private void SortCurves(CurveArray lines)
      {
        ...
        /// <summary>
        /// Получить подключенную кривую для текущей кривой
        /// </summary>
        /// <param name="profile">замкнутый контур, созданный выбором стен</param>
        /// <param name="connected">конечная точка текущей кривой</param>
        /// <param name="line">текущая кривая</param>
        /// <returns>соответствующая кривая для создания пола</returns>
